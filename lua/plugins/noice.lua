    ...
    config = function()
        ...
        noice.setup({
            ...
            cmdline = {
                ...
                view = "cmdline_popup", -- các dạng hiển thị, gồm: "cmdline_popup", "cmdline"
                opts = {},          -- tùy chọn chung cho cmdline
            ...
            messages = {
                enabled = true,          -- thay thế chức năng hiển thị thông báo mặc định của neovim
                view = "notify",         -- chế độ xem mặc định gồm: "cmdline_popup", "cmdline", "notify", "split"
                view_error = "notify",   -- chế độ xem cho lỗi
                view_warn = "notify",    -- chế độ xem cho cảnh báo
                view_history = "messages", -- chế độ xem cho :messages
                view_search = "virtualtext", -- chế độ xem hiển thị số lưọng kết quả tìm kiếm. Chỉnh 'false' để tắt
            },
            popupmenu = {
