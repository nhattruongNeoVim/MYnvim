...
return {
	...
	config = function()
		...
		local mappings = {
			...
			m = {
				name = "Mark",
				m = { "<cmd>lua require('bookmarks').bookmark_toggle()<cr>", "Toggle mark" },
				j = { "<cmd>lua require('bookmarks').bookmark_next()<cr>", "Mark next" },
				k = { "<cmd>lua require('bookmarks').bookmark_prev()<cr>", "Mark prev" },
				l = { "<cmd>lua require('bookmarks').bookmark_list()<cr>", "Mark list" },
				c = { "<cmd>lua require('bookmarks').bookmark_clean()<cr>", "Mark clear" },
				a = { "<cmd>lua require('bookmarks').bookmark_ann()<cr>", "Mark annotation" },
			},
		}
